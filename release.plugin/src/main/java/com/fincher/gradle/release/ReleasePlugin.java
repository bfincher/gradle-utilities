...
public class ReleasePlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		 ...
		 * { merger.withProperties(properties -> { try { properties.load(
		 * ReleasePlugin.class.getClassLoader().getResourceAsStream(
		 * "default.jdt.core.prefs")); } catch (IOException e) { throw new
